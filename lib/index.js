...
class RNGMSService {
    provideAPIKey(key, provider) {
        ...
        const RNGMSServiceNative = react_native_1.NativeModules.RNGMSService;
        RNGMSServiceNative.provideAPIKey(key);
    }
}
exports.RNGMSService = RNGMSService;
exports.rnGMSService = new RNGMSService();
